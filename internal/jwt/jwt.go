...
type IJWT interface {
	GenerateJWT(id string, isValid bool, seconds int) string
	GenerateRefreshToken(id string, isValid bool, seconds int) (string, time.Time)
...
func (j *JWT) GenerateJWT(id string, isValid bool, seconds int) string {
	claims := Claims{
		ID:      id,
		IsValid: isValid,
...
func (j *JWT) GenerateRefreshToken(id string, isValid bool, seconds int) (string, time.Time) {
